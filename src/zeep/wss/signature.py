"""Functions for WS-SecurityPolicy (WSS) signature creation and verification.

Heavily based on test examples from WSSE
well as the xmlsec documentation at https://schemasxmlsoap.azurewebsites.net/ws/2002/12/secext/

https://schemas.xmlsoap.org/ws/2002/12/secext/secext.xsd
...
from zeep.wss.utils import ensure_id, get_security_header
